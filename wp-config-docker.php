...
# Where to disable or not wordpress crons:
define('DISABLE_WP_CRON', (bool) getenv_docker('WORDPRESS_DISABLE_CRON', false) );
...
// Hardcode the Siteurl:
if( !empty(getenv_docker('WORDPRESS_SITE_URL', '')) )
{
